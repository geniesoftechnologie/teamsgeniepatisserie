...
public class Vol {
    ...
    public Vol(int id_avion, int id_aeroport, String nom_aero, Date datedepart, Date datearrivee, String heurdepart, String heurarrivee, int prix, int nbplacereserve, int id_aeroport_ar, String nom_aero_ar, int duree, int etat) {
    ...
    public Vol(int id, int id_avion, int id_aeroport, String nom_aero, Date datedepart, Date datearrivee, String heurdepart, String heurarrivee, int prix, int nbplacereserve, int id_aeroport_ar, String nom_aero_ar, int duree, int etat) {
        this.id = id;
        this.id_avion = id_avion;
        this.id_aeroport = id_aeroport;
        this.nom_aero = nom_aero;
